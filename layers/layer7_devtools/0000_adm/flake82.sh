...
layer_wrapper --layers=python2_devtools@mfext,-python2_misc@mfext,-python2@"${MODULE_LOWERCASE}" -- flake8 --ignore D101,D102,D103,D100,D104,D401,D413,D107,D200,D204,D210,D400,D412,D105 "$@"
