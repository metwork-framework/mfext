...
$(PREFIX)/bin/resty:
	...
	$(MAKE) --file=../../Makefile.standard PREFIX=$(PREFIX) OPTIONS="--with-pcre=$(PCRE_SOURCE_PATH) --without-lua_resty_memcached --without-lua_resty_mysql --without-lua_resty_websocket --without-http_scgi_module --without-http_uwsgi_module --http-fastcgi-temp-path=/tmp --without-http_ssi_module --with-http_dav_module --with-http_sub_module --with-http_realip_module --with-http_stub_status_module --http-client-body-temp-path=/tmp/nginx_clientbody_temp --http-proxy-temp-path=/tmp/nginx_proxy_temp --with-threads" download uncompress configure build install
