...
$(PREFIX)/lib/libgdal.so:
	$(MAKE) --file=../../Makefile.standard PREFIX=$(PREFIX) OPTIONS="--enable-shared --disable-static --with-pg=yes --with-liblzma=yes --with-proj=$(PREFIX) --with-openjpeg=$(PREFIX) --with-jasper=$(PREFIX) --with-hdf5=$(PREFIX) --with-hdf4=$(PREFIX) --with-spatialite=$(PREFIX) --with-netcdf --with-python=no" download uncompress configure build install
