...
export CHECKSUM=c66c7958748d444a4a2359342fe406ee
DESCRIPTION=\
...
$(PREFIX)/lib/libgdal.so:
	$(MAKE) --file=../../Makefile.standard PREFIX=$(PREFIX) OPTIONS="-DGDAL_USE_INTERNAL_LIBS=WHEN_NO_EXTERNAL -DCMAKE_BUILD_TYPE=Release -DBUILD_PYTHON_BINDINGS:BOOL=OFF -DTIFF_LIBRARY=$(PREFIX)/../core/lib/libtiff.so -DTIFF_INCLUDE_DIR=$(PREFIX)/../core/include -DLIBAEC_LIBRARY=$(PREFIX)/../core/lib/libaec.so -DLIBAEC_INCLUDE_DIR=$(PREFIX)/../core/include" download uncompress configure_cmake build_cmake install_cmake
