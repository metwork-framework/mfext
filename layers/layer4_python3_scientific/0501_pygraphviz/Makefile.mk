...
all:: $(PREFIX)/lib/python$(PYTHON3_SHORT_VERSION)/site-packages/pygraphviz-1.5-py2.7.egg-info
$(PREFIX)/lib/python$(PYTHON3_SHORT_VERSION)/site-packages/pygraphviz-1.5-py2.7.egg-info:
