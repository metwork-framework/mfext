...
$(PREFIX)/lib/libcgraph.so:
	$(MAKE) --file=../../Makefile.standard PREFIX=$(PREFIX) OPTIONS="--disable-python --disable-guile --disable-java --disable-perl --disable-lua --disable-tcl --disable-swig --disable-sharp --disable-ocaml --disable-php --disable-r --disable-ruby" download uncompress configure build install
