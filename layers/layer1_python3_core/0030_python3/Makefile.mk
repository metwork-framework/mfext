...
$(PREFIX)/bin/python:
	make --file=../../Makefile.standard EXTRACFLAGS="-I$(PREFIX)/../core/include" EXTRALDFLAGS="-L$(PREFIX)/../core/lib" OPTIONS="--enable-shared --enable-loadable-sqlite-extensions --without-ensurepip --with-openssl=$(PREFIX)/../core" download uncompress configure build install
