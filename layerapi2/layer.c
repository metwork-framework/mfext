...
void _layer_load(Layer *layer, gboolean force_prepend, GString **bash_cmds)
{
    ...
    conditional_prepend_env(layer->home, "local/lib", force_prepend, "PYTHONPATH", bash_cmds);
    conditional_prepend_env(layer->home, "lib", force_prepend, "LD_LIBRARY_PATH", bash_cmds);
    conditional_prepend_env(layer->home, "lib", force_prepend, "PYTHONPATH", bash_cmds);
