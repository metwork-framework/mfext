...
doc:: predoc
	...
	if test -d doc; then cd doc && layer_wrapper --layers=devtools@mfext,-python3@$(MODULE_LOWERCASE) -- make html && rm -Rf $(MODULE_HOME)/html_doc && cp -Rf _build/html $(MODULE_HOME)/html_doc; fi
